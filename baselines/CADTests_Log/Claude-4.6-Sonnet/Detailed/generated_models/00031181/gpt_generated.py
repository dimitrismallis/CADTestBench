...
def create_cad()-> cq.Workplane:
    ...
    def create_cad() -> cq.Workplane:
        # --- Step 1: Define dimensions (converted from meters to mm) ---
        length = 611.35   # mm (0.61135 m)
        width  = 360.26   # mm (0.36026 m)
        height = 338.43   # mm (0.33843 m)
    
        # --- Step 2: Create rectangular prism centered at origin ---
        ...
        # Top and bottom faces at correct Z positions
...
final_result = create_cad()
cq.exporters.export(final_result, 'experiments/claude_react_cadtests_final_detailed_2/generation_20260227_130041/generated_models/00031181/gpt_generated.stl')
